    ...
    <div className="min-h-screen bg-[#050816] text-white font-sans overflow-x-hidden">
      ...
      <main className="relative pt-24 sm:pt-32 pb-16 px-3 sm:px-8 lg:px-16 max-w-7xl mx-auto space-y-10 sm:space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          >
            {/* CTO Tag Badge */}
            <div className="inline-flex items-center gap-2 rounded-full border border-purple-500/40 bg-purple-950/40 px-3.5 py-1.5 text-xs font-semibold uppercase tracking-wider text-purple-300 backdrop-blur-md shadow-md">
              <Sparkles size={14} className="text-purple-400" />
              <span>Co-Founder & Chief Technology Officer (CTO)</span>
            </div>

            {/* Headline Name */}
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold font-playfair tracking-tight text-white">
              Sachin <span className="bg-gradient-to-r from-purple-400 via-fuchsia-400 to-cyan-400 bg-clip-text text-transparent">Rawat</span>
            </h1>
            ...
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed max-w-2xl mx-auto lg:mx-0">
              Passionate about building scalable backend infrastructure, cloud architectures, and AI-driven web applications. Dedicated to crafting reliable, high-performance digital systems that empower modern businesses to scale effortlessly.
            </p>
          </motion.div>
          ...
          >
            <div className="relative flex h-[250px] w-[250px] sm:h-[360px] sm:w-[360px] items-center justify-center shrink-0">
              ...
              <motion.div
                ...
                className="absolute inset-0 rounded-full border-2 border-dashed border-purple-500/40 shadow-[0_0_40px_rgba(168,85,247,0.25)]"
              />
              ...
              <div className="relative z-10 flex h-[210px] w-[210px] sm:h-[290px] sm:w-[290px] flex-col items-center justify-center gap-2 sm:gap-3 rounded-full border border-white/10 bg-slate-950/90 p-4 sm:p-6 text-center backdrop-blur-2xl shadow-2xl shrink-0">
                ...
                <div>
                  <h3 className="text-base sm:text-2xl font-bold text-white font-playfair">Sachin Rawat</h3>
                  <p className="text-[9px] sm:text-xs font-bold tracking-wider text-cyan-300 uppercase mt-0.5">Co-Founder & CTO</p>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-stretch">
          ...
          >
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-center gap-2.5">
                <Hexagon size={18} className="text-purple-400 sm:w-5 sm:h-5" />
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-4">
                {[
                  ...
                  { title: 'Brand Design', icon: Compass },
                  { title: 'User Research', icon: UserCheck },
                  ...
                  return (
                    <div
                      key={item.title}
                      className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-1.5 sm:gap-3 rounded-xl sm:rounded-2xl border border-white/10 bg-slate-900/60 p-2.5 sm:p-3.5 hover:border-purple-500/40 transition-all group"
                    >
                      <div className="h-7 w-7 sm:h-9 sm:w-9 rounded-lg sm:rounded-xl bg-purple-950/80 border border-purple-500/30 flex items-center justify-center text-purple-400 shrink-0 group-hover:scale-105 transition-transform">
          ...
          >
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-center gap-2.5">
                <Trophy size={18} className="text-cyan-400 sm:w-5 sm:h-5" />
              ...
              <ul className="space-y-2.5 sm:space-y-3.5 text-xs sm:text-sm text-slate-300">
                <li className="flex items-start gap-2 sm:gap-3">
                  <CheckCircle2 size={14} className="text-purple-400 shrink-0 mt-0.5 sm:w-4 sm:h-4" />
                ...
                <li className="flex items-start gap-2 sm:gap-3">
                  <CheckCircle2 size={14} className="text-purple-400 shrink-0 mt-0.5 sm:w-4 sm:h-4" />
                  <span>Published design expert & technical architect</span>
                </li>
              </ul>
            </div>

            {/* Bottom Callout Banner */}
            <div className="rounded-xl sm:rounded-2xl border border-purple-500/30 bg-purple-950/30 p-3 sm:p-4 flex items-center gap-3">
              <div className="h-8 w-8 sm:h-9 sm:w-9 rounded-lg sm:rounded-xl bg-purple-900/60 border border-purple-500/40 flex items-center justify-center text-purple-300 shrink-0">
                <Star size={16} />
              </div>
              <p className="text-[10px] sm:text-xs text-purple-200 leading-relaxed font-medium">
                Passionate about solving complex problems with clean design & scalable technology.
              </p>
            </div>
          </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-2.5 sm:gap-4">
            {[
              ...
              <div
                key={tech.name}
                className="flex flex-col items-center justify-center p-2.5 sm:p-4 rounded-xl sm:rounded-2xl border border-white/10 bg-slate-900/80 hover:border-purple-400/50 transition-all text-center group cursor-pointer shadow-md"
              >
        ...
        >
          ...
          <a
            href="/#contact"
            className="inline-flex items-center justify-center gap-1.5 rounded-full bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 px-4 py-2.5 sm:px-6 sm:py-3.5 text-[10px] sm:text-sm font-semibold text-white shadow-lg cursor-pointer"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center justify-center gap-1.5 rounded-full border border-purple-500/30 bg-purple-950/40 px-4 py-2.5 sm:px-6 sm:py-3.5 text-[10px] sm:text-sm font-semibold text-purple-300 hover:border-purple-400 transition-all cursor-pointer"
          >
